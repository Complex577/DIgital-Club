...
def init_db():
    ...
    try:
        ...
        print(f"Database already exists or error occurred: {e}")

def add_sample_data():
    """Add sample data for testing."""
    # Sample topics
    topics_data = [
        {'name': 'Python Programming', 'description': 'Learn Python from basics to advanced concepts', 'icon': 'fab fa-python'},
        {'name': 'Web Development', 'description': 'HTML, CSS, JavaScript, and modern frameworks', 'icon': 'fas fa-code'},
        {'name': 'Mobile Development', 'description': 'Android and iOS app development', 'icon': 'fas fa-mobile-alt'},
        {'name': 'Data Science', 'description': 'Data analysis, machine learning, and AI', 'icon': 'fas fa-chart-line'},
        {'name': 'Cybersecurity', 'description': 'Ethical hacking and security practices', 'icon': 'fas fa-shield-alt'},
        {'name': 'Cloud Computing', 'description': 'AWS, Azure, and cloud technologies', 'icon': 'fas fa-cloud'},
    ]
    ...
    for blog_item_data in blog_data:
        if not Blog.query.filter_by(title=blog_item_data['title']).first():
